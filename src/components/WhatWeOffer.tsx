  ...
  return (
    <section ref={sectionRef} className="section-padding bg-secondary/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-primary/5 rounded-full blur-[120px] translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gold/5 rounded-full blur-[100px] -translate-x-1/2 translate-y-1/2" />
      </div>
          ...
          {offerings.map((offering, index) => (
            ...
            >
              <motion.div
                ...
                className="h-full p-8 rounded-2xl bg-card glass-card border border-transparent hover:border-primary/10 transition-all duration-500"
              >
